...
def main():
    ...
    parser.add_argument('--output_predictions_path', type=str, help='folder to store rbdaim predictions', default="./output_cv/")
    parser.add_argument('--output_models_path', type=str, help='folder to store rbdaim weights', default="./models/")

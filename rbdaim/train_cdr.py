...
def main():
    ...
    parser.add_argument('--cv_ensemble_ids', default=None, type=lambda s: [int(item) for item in s.split(',')], help='A unique id for CV evaluation of the rbdaim')
    parser.add_argument('--device', type=str, help='device', default="cuda:0")
    parser.add_argument('--model_type', type=str, help='rbdaim', default="CLS")
    ...
    parser.add_argument('--model_config', type=str, help='rbdaim config', default="./configs/rbdaim.json")
    parser.add_argument('--train_cv', type=bool, help='train CV rbdaim', default=True)
    parser.add_argument('--train_full', type=bool, help='train full rbdaim', default=False)
    parser.add_argument('--hyp_search', type=bool, help='hyperparameters search mode', default=False)   
    parser.add_argument('--output_predictions_path', type=str, help='folder to store rbdaim predictions', default="./output/")
    parser.add_argument('--output_models_path', type=str, help='folder to store rbdaim weights', default="./weights/")
